...
pub mod thread_program {
    ...
    pub fn thread_big_instruction_add(ctx: Context<ThreadBigInstructionAdd>, instruction_data: Vec<u8>) -> Result<()> {
        thread_big_instruction_add::handler(ctx, instruction_data)
    }
